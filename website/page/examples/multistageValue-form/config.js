...
export const model = {
    ...
    cascaderApi: {abc: []},
    tableSelect: {abc: 1},
    multipleTableSelect: {abc: [1, 2]},
    tree: {abc: ['2']},
    multipleTree: {abc: ['1', '2', '10']},
    inputNumber: {abc: 12},
    logicInput: {
        abc: {}
    },
